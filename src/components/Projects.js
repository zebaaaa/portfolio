...
function Projects() {
  ...
  return (
    <div
      id="Projects"
      className="py-16 px-4 sm:px-6 md:px-10 bg-[#fffbd4] 
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 
        ...
        {projects.map((project, index) => (
          <motion.div
            ...
            max-w-[380px] mx-auto"  // ⭐ smaller card width
          >
            {/* IMAGE SECTION */}
            <div className="p-4">
            ...
            {/* INFO SECTION */}
            <div className="px-5 pb-5 text-black font-semibold">
              ...
              {/* ⭐ ORIGINAL GLOBE ICON LOGIC RESTORED */}
              <div className="flex justify-end">
                <a href={project.github}>
                  <FaGlobe className="text-2xl text-gray-700 hover:text-black transition" />
                </a>
              </div>
            </div>
          </motion.div>
